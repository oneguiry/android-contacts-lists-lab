...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        ArrayList<FilterContactTypeUi> filterContacts = new ArrayList<>();
        for (String contact : contacts) {
            filterContacts.add(createFilterContactType(contact));
        }
        filterContactTypesLiveDate.setValue(filterContacts);
    }
